...
class MusicManager: ObservableObject {
    ...
    private func checkIfAnyMusicAppIsRunning() -> Bool {
        ...
        // Fourth check: check if any media anywhere is playing
        // This guarantees that the media controller runs when playback starts, even if the media isn't coming from a dedicated media app
        if (self.isPlaying) {
            return true
        }
